                                        ...
                                        <table>
                                            <tbody>
                                                ...
                                                <tr class="tabletitle">
                                                    ...
                                                    <td>
                                                        <h4>{{ 'Rp. ' . number_format($sale['total_price'], 0, ',', '.') }}
                                                        </h4>
                                                    </td>
                                                </tr>
                                                <tr class="tabletitle">
                                                    ...
                                                    <td>
                                                        <h4>{{ 'Rp. ' . number_format($sale['total_pay'], 0, ',', '.') }}
                                                        </h4>
                                                    </td>
                                                </tr>
                                            </tbody>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" id="name" class="form-control"
                                                required value="{{ $sale->member->name ?? '' }}">
                                        </div>
                                        <div class="form-group">
                                            <label for="poin" class="form-label">Poin</label>
                                            <input type="text" name="point" id="point"
                                                value="{{ $sale->member ? $sale->member->point : '' }}" disabled=""
                                                class="form-control">
                                        </div>
                                        <div class="form-check ms-4">
                                            <input class="form-check-input" type="checkbox" value="1"
                                                name="use_point_request" {{ $isFirst ? 'disabled' : '' }}>
